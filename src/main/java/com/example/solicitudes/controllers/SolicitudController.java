package com.example.solicitudes.controllers;
...
import com.example.solicitudes.models.ResponseMessage;
import com.example.solicitudes.models.Solicitud;
import com.example.solicitudes.services.SolicitudService;

@RestController
public class SolicitudController {
private static final Logger logger = LoggerFactory.getLogger(SolicitudController.class);
	
	private static final String FILEPATH = "/solicitudes/images";
	...
	public ResponseMessage crear(@RequestParam(name="imagen", required=false) MultipartFile imagen, @RequestParam("correo") String correo, @RequestParam("tipo") String tipo, @RequestParam("descripcion") String descripcion) {
